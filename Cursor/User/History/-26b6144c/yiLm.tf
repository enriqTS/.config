...
import {
  to = module.compute.module.lambda.module.responder-mensagem.aws_lambda_function.responder-mensagem
...
# responder-mensagem IAM role
import {
  to = module.compute.module.lambda.module.responder-mensagem.aws_iam_role.responder-mensagem-role-lfmb0m6m
  id = "responder-mensagem-role-lfmb0m6m"
}

# responder-mensagem IAM role policy attachment
import {
  to = module.compute.module.lambda.module.responder-mensagem.aws_iam_role_policy_attachment.responder-msgs-policy
  id = "responder-mensagem-role-lfmb0m6m/arn:aws:iam::700308877414:policy/responder-msgs-policy"
}

# envia-template IAM role
import {
  to = module.compute.module.lambda.module.envia-template.aws_iam_role.lambda_role
  id = "envia-template-role-1uec1cvy"
}

# envia-template IAM role policy attachment
import {
  to = module.compute.module.lambda.module.envia-template.aws_iam_role_policy_attachment.lambda_logs
  id = "envia-template-role-1uec1cvy/arn:aws:iam::700308877414:policy/envia-template-policy"
}
...
# requests layer (version 1)
import {
  to = module.compute.module.lambda.aws_lambda_layer_version.requests
  id = "arn:aws:lambda:us-east-1:700308877414:layer:requests:1"
}
